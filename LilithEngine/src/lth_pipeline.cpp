...
namespace lth {
	...
	LthPipeline::LthPipeline(
		LthDevice& device,
		const PipelineConfigInfo& configInfo,
		const std::string& vertFilePath,
		const std::string& fragFilePath) : lthDevice(device) {
	...
	void LthPipeline::bind(VkCommandBuffer commandBuffer) {
		vkCmdBindPipeline(commandBuffer, VK_PIPELINE_BIND_POINT_GRAPHICS, graphicsPipeline);
	}

	void LthPipeline::defaultPipelineConfigInfo(PipelineConfigInfo& configInfo) {
	...
	void LthPipeline::enableAlphaBlending(PipelineConfigInfo& configInfo) {
	...
	void LthPipeline::createGraphicsPipeline(
		const PipelineConfigInfo& configInfo,
		const std::string& vertFilePath,
